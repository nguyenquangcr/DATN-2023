            ...
            <div className='clearfix'>
                {
                    !props.skeletonLoading && posts.length ? (
                        <>
                            <div className={classNames(styles['featured-news-left'],  'fl')}>
                                                    ...
                                                    <li key={post.pid}>
                                                        <Link href={'/post?slug=' + post.slug + '&pid=' + post.pid} as={'/' + post.slug + '-p' + post.pid + '.html'}>
                                                            <a title={post.title} className={styles['featured-image']}>
                                                                <ProgressiveMedia alt={post.title} thumb={post.background} src={post.background} />
                                                            </a>
                                                        </Link>
...
FeaturedNewsWidget.defaultProps = defaultProps;
