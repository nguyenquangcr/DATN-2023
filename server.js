...
app.prepare().then(() => {
    ...
    server.get('/:slug-c:cid(\\d+).html', (req, res) => {
        return app.render(req, res, '/category-by-id', {
    ...
    // Route Category eq. https://meovathay.vn/giai-tri.htm
    ...
    // Route Category Children eq. https://meovathay.vn/giai-tri/tv-show.htm
    ...
    // Route Hot news eq. https://meovathay.vn/tin-nong.html
    ...
    server.get('/user/:username(\\d+)', (req, res) => {
